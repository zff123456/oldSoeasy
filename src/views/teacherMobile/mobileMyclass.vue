<template>
  <div class="right">
    <div class="titleBox">
      <ul>
        <li>班级名称</li>
        <li><el-input v-model="classname" style="width:4rem;border-radius: 2px;" placeholder="必填项"></el-input></li>
        <br>
        <li>班级人数</li>
        <li><el-input v-model="people" style="width:4rem;border-radius: 2px;" type="number" placeholder="必填项"></el-input></li>
        <li><el-button type="primary" @click="submitForm" style="margin-left:.266667rem;padding:7.5px 14px">新增班级</el-button></li>
    ...
    <div class="table-box">
      <el-table :data="flatten(tableData.slice((currentPage -1) * pagesize, currentPage * pagesize))" stripe style="" border :row-style="{height:'48px'}"  :header-row-style="{height:'48px'}">
        ...
        <el-table-column prop="class_name" label="班级名称" min-width="90"></el-table-column>
        <el-table-column prop="student_num" label="应有学生数" min-width="90"></el-table-column>
          ...
          <template slot-scope="scope">
            <el-dropdown trigger="click">
              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item style="margin:.133333rem 0;text-align: right;"><el-button size="mini" type="success" @click="speak(scope.row)">编辑</el-button></el-dropdown-item>
                <el-dropdown-item style="margin:.133333rem 0;text-align: right;"><el-button size="mini" type="danger" @click="open(scope.row)">删除</el-button></el-dropdown-item>
                <el-dropdown-item style="margin:.133333rem 0;text-align: right;"><el-button size="mini" type="primary" @click="transferaseStu(scope.row)">学生</el-button></el-dropdown-item>
                <el-dropdown-item style="margin:.133333rem 0;text-align: right;"><el-button size="mini" type="warning" @click="transferaseTeacher(scope.row)">转移</el-button></el-dropdown-item>
                <el-dropdown-item style="margin:.133333rem 0;text-align: right;"><el-button size="mini" type="primary" @click="exportExcel(scope.row)">导出成绩</el-button></el-dropdown-item>
              </el-dropdown-menu>
            </el-dropdown>
          </template>
        </el-table-column>
...
export default {
  ...
  methods: {
    ...
    transferaseStu(e){ // 转移班级
      ...
      this.$router.push({ name: "myClassStudentList" });
    },
