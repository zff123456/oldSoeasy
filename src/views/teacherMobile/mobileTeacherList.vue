<template>
  ...
  <div class="right" v-loading="isLoading" element-loading-text="拼命加载中">
    <div class="search-box">
      <el-input v-model="type" placeholder="请输入教师姓名" style="width:6.666667rem;" clearable></el-input>
      <el-button type="primary" icon="el-icon-search" @click="searchStu" style="margin-left:.266667rem">搜索</el-button>
    </div>
    <div class="table-box">
      <el-table stripe style="" border :data="flatten(tableData.slice((currentPage -1) * pagesize, currentPage * pagesize))" :row-style="{height:'48px'}"  :header-row-style="{height:'48px'}">
        <el-table-column prop="nickname" label="教师姓名" min-width="90"></el-table-column>
        ...
        <el-table-column prop="name" label="账号" min-width="90"></el-table-column>
