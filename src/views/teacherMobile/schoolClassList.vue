  ...
  <div class="right" v-loading="isLoading" element-loading-text="拼命加载中">
    ...
    <div class="table-box">
      <el-table :data="flatten(tableData.slice((currentPage -1) * pagesize, currentPage * pagesize))" stripe style="" border :row-style="{height:'48px'}"  :header-row-style="{height:'48px'}">
        ...
        <el-table-column prop="use_num" label="班级注册人数" min-width="90"></el-table-column>
        ...
        <el-table-column label="操作" min-width="120" align="center">
          ...
          <!-- <template slot-scope="scope">
            ...
            <el-button size="mini" type="warning" @click="transferaseTeacher(scope.row)" :disabled="type == 2">转移</el-button>
          </template> -->
...
export default {
  ...
  methods: {
    ...
    transferaseStu(e){ // 转移班级
      ...
      this.$router.push({ name: "schoolClassStuList" });
    },
