<template>
  <div class="right" v-loading="isLoading" element-loading-text="拼命加载中">
    ...
    <div class="table-box">
      ...
      :row-style="{height:'48px'}"  :header-row-style="{height:'48px'}">
      <!-- @selection-change="handleSelectionChange" -->
        ...
        <el-table-column prop="name" label="账号" min-width="60"></el-table-column>
      ...
      <!-- <div class="transfer-box">
        <el-button type="primary" @click="goback">返回学校班级</el-button>
      </div> -->
      <!-- 分页插件。 -->
      ...
      <!-- 导出Excel -->
      <el-button type="primary" @click="exportExcel" icon="el-icon-upload2" class="excel" style="float: right;margin:15px">导出Excel</el-button>
    </div>
    <!-- 转移学生,弹出班级列表 -->
