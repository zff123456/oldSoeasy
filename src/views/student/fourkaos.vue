    ...
    <div class="right">
      ...
      <div class="kaoshi-box">
        <div class="button-box">
          ...
          <el-button type="primary" plain @click.native="check(2)" :class="isCheck == 2?'checked':''">听短文理解</el-button>
          <el-button type="primary" plain @click.native="check(3)" :class="isCheck == 3?'checked':''">选词填空</el-button>
          <el-button type="primary" plain @click.native="check(4)" :class="isCheck == 4?'checked':''">新闻报道</el-button>
        ...
        <div class="component-box">
          ...
          <div class="big-box" v-show="isCheck == 4">
            ...
            <div v-for="(item, key, index) in xinwenbaodao" class="duanwen-box">
              <el-button size="mini" type="primary" icon="el-icon-video-play" @click ="play_xinwen(item,key)" :disabled="duanwenPlay">第{{key + 1}}题</el-button>
          ...
          <div class="big-box" v-show="isCheck == 8">
            ...
            <div v-html="pianzhangfanyi.daan" v-if="is_tijiao" style="border: 1px solid #ccc;padding:10px">{{pianzhangfanyi.daan}}</div>
            <div v-html="pianzhangfanyi.jiexi" v-if="is_tijiao" style="margin-top:10px;border: 1px solid #ccc;padding:10px">{{pianzhangfanyi.jiexi}}</div>
          </div>
        </div>
