<template>
  <div class="right">
    <div class="title-box">
      ...
      <!-- <el-button type="warning" style="position: absolute;top: 0px;right:10px;font-size:16px">暂停作答</el-button> -->
    </div>
    <div class="kaoshi-box">
      ...
      <div class="component-box">
        ...
        <div class="big-box fs16" v-show="isCheck == 4">
          <div class="zuowen-title fs16">Directions: In this section, you will hear several newsreports.At the end of each news report, you will hear two or three questions. Both the news report and the questions will be spoken only once. After you hear a question, you must choose the best answer from the four choices marked A，B，C and D. Then select the corresponding letter on the web page.</div>
          <audio ref="xinwenOpt" size="mini"></audio>
          <div v-for="(item, key, index) in tingduanwen" class="duanwen-box">
            <el-button size="mini" type="primary" icon="el-icon-video-play" @click ="play_xinwen(item,key)" :disabled="duanwenPlay">播放听力</el-button>
            ...
            <div class="duanwen-options fs16" >
              <div class="option-one fs16" v-for="(ie, k, index) in item.xuanzhe">
                ...
                <div v-if="is_tijiao" v-html="ie.jiexi" style="margin-top:10px;border: 1px dashed #ccc;padding:10px" class="fs16">{{ie.tiyan}}</div>
                <div v-if="is_tijiao" v-html="ie.daan" style="margin-top:10px;border: 1px dashed #ccc;padding:10px" class="fs16">{{ie.jiexi}}</div>
              </div>
            </div>
          </div>
        </div>
