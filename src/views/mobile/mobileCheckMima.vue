...
export default {
  ...
  methods: {
    async getItem(){
      const res = await this.$http.get(`admin/teacher/studentChangePassword?id=${this.id}`);
    ...
    async submitForm(){
      ...
      const res = await this.$http.post("admin/teacher/studentChangePassword",qs.stringify({
